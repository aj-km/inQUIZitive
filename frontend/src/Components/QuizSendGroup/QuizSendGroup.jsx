...
import { sendQuiz, sendQuizToGroup } from '../../Actions/quizActions';
import './QuizSendGroup.css';
...
const QuizSendGroup = () => {
  ...
  const submitHandler = (e) => {
    e.preventDefault();
    dispatch(sendQuizToGroup(groupName, quizTitle, quizStartDate, quizStartTime, quizEndDate, quizEndTime));
  };
